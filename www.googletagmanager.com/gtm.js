...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "macros": [{
                ...
                "function": "__jsm",
                "vtp_javascript": ["template", "(function(){var b='input[type\\x3d\"tel\"]',c=document.querySelectorAll(b);for(b=0;b\u003Cc.length;b++){var a=c[b].value.replace(\/\\D\/g,\"\");if(\"\"!==a\u0026\u00260!==a\u0026\u0026\"0\"!==a\u0026\u0026null!==a\u0026\u0026!1!==a\u0026\u0026void 0!==a){action_id=a;break}}return action_id})();"]
            }, {
                "function": "__u",
                "vtp_component": "URL",
                "vtp_enableMultiQueryKeys": false,
            ...
            "tags": [{
                ...
                "consent": ["list"],
                "once_per_event": true,
                "vtp_html": ["template", "\u003Cscript type=\"text\/gtmscript\"\u003Evar img=new Image(1,1),action_id_pxl=", ["escape", ["macro", 2], 8, 16], ",offer_id=640,goal=\"1\",status=2;function empty(a){return\"\"===a||0===a||\"0\"===a||null===a||!1===a||void 0===a}img.src=\"https:\/\/offers.guruleads.ru\/conversion\/\"+offer_id+\".pxl?action_id\\x3d\"+action_id_pxl+\"\\x26goal\\x3d\"+goal+\"\\x26status\\x3d\"+status;\u003C\/script\u003E\n"],
    ...
    */
    ...
    var hc = /[\x00\x08-\x0d\x22\x26\x27\/\x3c-\x3e\\\x85\u2028\u2029]/g,
        ic = {
            "\x00": "\\x00",
            "\b": "\\x08",
            "\t": "\\t",
    ...
    ac[8] = function(a) {
        ...
        switch (typeof a) {
            ...
            case "number":
                return " " + a + " ";
            default:
                return "'" + String(String(a)).replace(hc, jc) + "'"
        }
    };
    ...
    var Yd = {},
        ...
        $d = {},
        ae = Object.freeze(($d[N.g.jg] = 1, $d[N.g.kg] = 1, $d[N.g.mc] = 1, $d[N.g.nc] = 1, $d[N.g.lg] = 1, $d[N.g.Ob] = 1, $d[N.g.oc] = 1, $d[N.g.rb] = 1, $d[N.g.Pb] = 1, $d[N.g.sb] = 1, $d[N.g.Ga] = 1, $d[N.g.qc] = 1, $d[N.g.Ha] = 1, $d[N.g.mg] = 1, $d)),
        ...
        ie = {},
        je = Object.freeze((ie[N.g.W] = 1, ie[N.g.sd] = 1, ie[N.g.wa] = 1, ie[N.g.ub] = 1, ie[N.g.Ce] = 1, ie[N.g.ud] = 1, ie[N.g.vd] = 1, ie[N.g.wd] = 1, ie[N.g.aa] = 1, ie[N.g.xd] = 1, ie[N.g.Ba] = 1, ie[N.g.na] = 1, ie[N.g.Oa] = 1, ie[N.g.Ca] = 1, ie[N.g.Pa] = 1, ie[N.g.Ia] = 1, ie[N.g.oa] = 1, ie[N.g.Fd] = 1, ie[N.g.V] = 1, ie[N.g.ui] = 1, ie[N.g.yc] = 1, ie[N.g.Id] = 1, ie[N.g.Ie] = 1, ie[N.g.Ld] = 1, ie[N.g.Qd] = 1, ie[N.g.Da] = 1, ie[N.g.Ac] = 1, ie[N.g.ra] = 1, ie[N.g.Ea] = 1, ie[N.g.Gg] = 1, ie[N.g.Hg] = 1, ie[N.g.Ig] =
            1, ie[N.g.Jg] = 1, ie[N.g.Cb] = 1, ie[N.g.Ka] = 1, ie[N.g.Eb] = 1, ie[N.g.Dc] = 1, ie[N.g.sa] = 1, ie[N.g.va] = 1, ie[N.g.Ec] = 1, ie[N.g.Xa] = 1, ie[N.g.ia] = 1, ie[N.g.xa] = 1, ie[N.g.ja] = 1, ie));
    Object.freeze(N.g);
    var ke = {},
    ...
    ke.Lc = Number("0") || 0;
    ke.ca = "dataLayer";
    ke.ai = "ChEI8IrUoQYQ1vjqrv2J34n3ARIkAOToB1Pf5ahkPLDK0AFT/jccy6f01Gfk/ntfOmySfxxXvx0+GgKVFQ\x3d\x3d";
    var ne = {
            __cl: !0,
            __ecl: !0,
            __ehl: !0,
        ...
        if (void 0 == b) Ya("TAGGING", 18);
            ...
            if ("" === d || p === e || (p === d ? n !== e : !p && !n)) {
                ...
                q && z.setTimeout(function() {
                    l[a] === t && t.quiet && (t.quiet = !1, hf(a), gf(), Ya("TAGGING", 2))
                }, f)
            }
        }
    }
    ...
    var uf = /:[0-9]+$/,
        ...
        zf = function(a, b, c, d, e) {
            ...
            if ("protocol" === b || "port" === b) a.protocol = xf(a.protocol) || xf(z.location.protocol);
            "port" === b ? a.port = String(Number(a.hostname ? a.port : z.location.port) || ("http" === a.protocol ? 80 : "https" ===
                a.protocol ? 443 : "")) : "host" === b && (a.hostname = (a.hostname || z.location.hostname).replace(uf, "").toLowerCase());
            return yf(a, b, c, d, e)
        },
    ...
    function Zg(a, b) {
        var c = b.split(".");
        5 === c.length ? (Rg[a] = c.slice(0, 2).join("."), Sg[a] = {
            id: c.slice(2, 4).join("."),
            Ff: Number(c[4]) || 0
        }) : 3 === c.length ? Sg[a] = {
            id: c.slice(0, 2).join("."),
    ...
    function ch() {
        if (!P(87)) return {};
        try {
            return JSON.parse(Wa("eyIwIjoiVVoiLCIxIjoiIiwiMiI6ZmFsc2UsIjMiOiJnb29nbGUuY28udXoiLCI0IjoiIiwiNSI6dHJ1ZSwiNiI6ZmFsc2UsIjciOiIifQ"))
        } catch (a) {
    ...
    var wi = function(a, b, c, d) {
        ...
        zi = /[?&]($|#)/,
        Ai = function(a, b, c) {
            for (var d, e = a.search(xi), f = 0, g, l = []; 0 <= (g = wi(a, f, b, e));) l.push(a.substring(f,
    ...
    Li.prototype.addEventListener = function(a) {
        ...
        var f = function(g, l) {
            clearTimeout(e);
            g ? (c = g, c.internalErrorState = Ki(c), c.internalBlockOnErrors = b.J, l && 0 === c.internalErrorState || (c.tcString = "tcunavailable", l || (c.internalErrorState = 3))) : (c.tcString = "tcunavailable", c.internalErrorState = 3);
            a(c)
        };
        try {
    ...
    var Oi = function(a, b, c) {
            ...
            else m = 1 === l ? a.purpose && a.vendor ? Ni(a.purpose.legitimateInterests,
                b) && Ni(a.vendor.legitimateInterests, void 0 === d ? "755" : d) : !0 : !0;
            return m
        },
        Ni = function(a, b) {
            return !(!a || !a[b])
    ...
    var jj = gj,
        kj = "https://www.googletagmanager.com/a?id=" + R.C + "&cv=4";
    ...
    function Uj(a) {
        ...
        var c = $a("GTM"),
            ...
            r = sj,
            u;
        return [f, g, l, c ? "&u=" + c : "", d ? "&ut=" + d : "", e ? "&h=" + e : "", m, n, p, q, t, r, u, uj ? "&dl=" + encodeURIComponent(uj) : "", 0 < tj.length ? "&tdp=" + tj.join(".") : "", ke.Lc ? "&x=" + ke.Lc : "",
            "&z=0"
        ].join("")
    }
        ...
        zk = function(a) {
            ...
            for (var d = {}, e = 0; e < c.length; d = {
                ...
                if (null != f) {
                    ...
                    p ? (p.timestamp = Math.max(p.timestamp, m), p.labels = Ck(p.labels, n || [])) : b.push({
                        version: l,
                        ba: d.kd,
                        timestamp: m,
                        labels: n
    ...
    var Gk = function() {
        ...
        Fk = function(a, b, c, d) {
            ...
            if (void 0 !== a && a.match(vk)) switch (b) {
                case void 0:
                    f(a,
                        "aw");
                    break;
    ...
    function Hk(a, b, c, d, e) {
        ...
        if (!m && a.gb) {
            var q = a.gb[0],
                ...
                r = !1;
            if (!b)
                for (var u = zk(t), v = 0; v < u.length; v++) u[v].ba === q && u[v].labels &&
    ...
    function um(a, b, c) {
        if (nm.test(C.location.host)) {
            ...
            if (d && 2 == d.length && d[1].match(mm)) return [{
                ba: d[1]
            }]
    ...
    var vo = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/),
        ...
        Bo = function(a) {
            ...
            zo() && (re ?
                J(116) : J(117), Ao && (b = [], window.console && window.console.log && window.console.log("GTM blocked. See go/13687728.")));
            var c = b && La(Ca(b), wo),
                d = Le("gtm.blocklist") || Le("gtm.blacklist");
            d || (d = Le("tagTypeBlacklist")) && J(3);
            d ? J(8) : d = [];
            zo() && (d = Ca(d), d.push("nonGooglePixels", "nonGoogleScripts", "sandboxedScripts"));
        ...
        Bq = function(a, b, c, d) {
            if (d.Z) {
                ...
                if (f) {
                    ...
                    try {
                        ck(d.messageContext.eventId, t, "1"), Ho(d.type, d.Z, u), f(d.Z, b, d.m, u)
                    } catch (v) {
    ...
    zq.prototype.push = function(a, b, c, d) {
        if (void 0 !== c) {
            ...
            if (c) {
                var e = al(c);
                e && 1 === Aq(this, c).status && (Aq(this, c).status = 2, this.push("require", [{}], e.U, {}))
            }
    ...
    zq.prototype.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.h.length;) {
            var f = this.h[0];
            if (f.messageContext.deferrable) !f.Z || Aq(this, f.Z).m ? (f.messageContext.deferrable = !1, this.h.push(f)) : c.push(f), this.h.shift();
            else {
                var g = void 0;
                switch (f.type) {
                    case "require":
    ...
    var Cq = function(a, b) {
            if ("require" !== b.type)
                if (b.Z)
                    for (var c = Aq(a, b.Z).M[b.type] || [], d = 0; d < c.length; d++) c[d]();
                else
                    for (var e in a.m)
    ...
    var Eq = {},
        ...
        Gq = function(a) {
            for (var b = [], c = [], d = {}, e = 0; e < a.length; d = {
                ...
                var f = a[e];
                if (0 <= f.indexOf("-")) d.od = al(f), d.od && (ta(ii(), function(p) {
                    return function(q) {
                        return p.od.U === q
                    }
                }(d)) ? b.push(f) : c.push(f));
            ...
            event: function(a, b) {
                ...
                if (!(2 > a.length) && h(c)) {
                    ...
                    var e = d,
                        f = {},
                        g = (f.event = c, f);
                    e && (g.eventModel = G(e), e[N.g.Sb] && (g.eventCallback = e[N.g.Sb]), e[N.g.Kd] &&
        ...
        for (var a = !1, b; !qr && (b = wr());) {
            ...
            if (null == d) qr = !1;
                ...
                try {
                    ...
                    if ("number" === typeof x) {
                        for (var A = mr[String(x)] || [], B = 0; B < A.length; B++) or.push(yr(A[B]));
                        A.length && or.sort(rr);
                        delete mr[String(x)];
                        x > lr && (lr = x)
                    }
    ...
    function Zp(a) {
        if (lr < a.notBeforeEventId) {
            ...
            mr[b] = mr[b] || [];
            mr[b].push(a)
        } else or.push(yr(a)), or.sort(rr), E(function() {
            qr || xr()
        })
    }
    ...
    var Er = function(a) {
        this.h = function(b) {
            for (var c = [], d = 0; d < a.length; d++) c.push(a[d] === Ec.Vd ? b : a[d]);
            return c.join("")
        }
    };
    ...
    Ec.ck = function(a, b, c) {
        a instanceof Ec.dj && (a = a.h(Ec.rk(b, c)), b = pa);
        return {
            Jj: a,
            N: b
        }
    ...
    var qu = window,
        ...
        su = function(a) {
            ...
            if (b && b.ioo && b.ioo() || ru.documentElement.hasAttribute("data-google-analytics-opt-out") || a && !0 === qu["ga-disable-" + a]) return !0;
            try {
                var c = qu.external;
    ...
    X.o.u = ["google"],
        function() {
            ...
            (function(b) {
                ...
                else f = zf(e, d, "HOST" == d ? b[a("vtp_stripWww")] : void 0, "PATH" == d ? b[a("vtp_defaultPages")] : void 0);
                return f
            })
        }();
            ...
            function b(d) {
                if (C.body) {
                    var e = d.vtp_gtmOnFailure,
                        ...
                        g = f.Jj,
                        l = f.N;
                    if (d.vtp_useIframe) {} else d.vtp_supportDocumentWrite ? c(g, l, e) : a(C.body, Pb(g), l, e)()
                } else es(function() {
                    b(d)
                }, 200)
            }
    ...
    var Mx = {};
    Mx.macro = function(a) {
        if (Ec.lf.hasOwnProperty(a)) return Ec.lf[a]
    }, Mx.onHtmlSuccess = Ec.th(!0), Mx.onHtmlFailure = Ec.th(!1);
    Mx.dataLayer = Me;
    ...
    (function(a) {
        ...
        if (xe) a();
            ...
            var f = function(u) {
                    ...
                    y || (y = [],
                        z["google.tagmanager.debugui2.queue"] = y, Hb("https://" + ke.qd + "/debug/bootstrap?id=" + R.C + "&src=" + w + "&cond=" + u + "&gtm=" + pi()));
                    var x = {
        ...
        if (R.jb ? le["ctid_" + R.jb] : le[R.C]) {
            ...
            Jo = !1;
            Ko = 0;
            if ("interactive" == C.readyState && !C.createEventObject || "complete" == C.readyState) Mo();
            else {
