...
function t_form_phonemask_init(e, t, n) {
    if (n && "undefined" !== n) t_form_phonemask_initPhoneMaskForm(e, t, n);
        ...
        a.open("GET", "https://geo.tildacdn.com/geo/country/", !0), a.onreadystatechange = function() {
            if (4 === a.readyState)
        ...
        if (p || (window.tildamode && "zero" === window.tildamode ? (p = a.querySelector('.tn-artboard [data-input-lid="' + t + '"]')) || (p = a.querySelector(".tn-artboard")) : (p = document.querySelector('[data-input-lid="' + t + '"]')) || (p = document.body)), !p.getAttribute("data-init-mask")) {
            ...
            if (o) {
                ...
                if (i[n]) var r = i[n];
                    ...
                    n = "ru";
                o.setAttribute("data-phonemask-iso", n), o.setAttribute("data-phonemask-code", n.length > 0 ? r.c : ""), o.setAttribute("data-phonemask-mask", n.length > 0 ? r.m : ""), t_form_phonemask__calcMaxlength(o);
...
function t_form_phonemask__initSelectEvents(e, t, n) {
    ...
    function l() {
        if (i.classList.contains("t-input-phonemask__options-wrap_open") ? x() : (x(), i.classList.add("t-input-phonemask__options-wrap_open")), 1 === a.length) {
            var n = a[0].getBoundingClientRect().height,
                ...
                r = p.height,
                s;
            n < o + i.getBoundingClientRect().height + r ? (i.style.top = "auto", i.style.bottom = "100%") : (i.style.bottom = "auto", i.style.top = "100%")
        }
    }
    ...
    t_form_phonemask__changeVal(t, p), o.addEventListener("click", l), p.addEventListener("input", u), Array.prototype.forEach.call(r, (function(e) {
