function t396_init(t) {
    ...
    d && (t396_initTNobj(t, d), o = t396_detectResolution(t), e = document.getElementById("allrecords"), window.tn_window_width = document.documentElement.clientWidth, window.tn["ab" + t].scaleFactor = parseFloat((window.tn_window_width / o).toFixed(3)), window.tn_scale_factor = parseFloat((window.tn_window_width / o).toFixed(3)), t396_switchResolution(t, o), t396_updateTNobj(t), t396_artboard_build("", t), i = "ontouchend" in document, window.addEventListener("resize", function() {
        ...
        t396_scaleBlock(t)
    }), n || "y" !== t396_ab__getFieldValue(d, "fixed") || t396_ab__updatePosOnScroll(d, a), n && r && d && (o = d.getAttribute("data-artboard-ovrflw"), r.style.position = "relative", r.style.zIndex = "auto" === o || "visible" === o ? "2" : "1"))
}
...
function t396_doResize(t) {
    ...
    "window" === t396_ab__getFieldValue(e, "upscale") && "edit" !== i && t_onFuncLoad("t396_scaleBlock", function() {
        t396_scaleBlock(t)
    }), "edit" !== i && "y" === t396_ab__getFieldValue(e, "fixed") && t396_ab__updateTildaLabelPadding(e), t396_allelems__renderView(e)
}
...
function t396_ab__updatePosOnScroll(i, t) {
    var n, o, a;
    i && t && (t396_ab__updateTildaLabelPadding(i), n = t396_ab__getFieldValue(i, "fixed-trigger"), t = "rgba(0, 0, 0, 0)" !== (t = getComputedStyle(i)).backgroundColor || "none" !== t.backgroundImage, !n && t && i.classList.add("t396__artboard-fixed"), n && (window.pageYOffset > n && i.classList.add("t396__artboard-fixed-active"), o = ["t396__artboard-fixed-active"], t && o.push("t396__artboard-fixed"), window.addEventListener("scroll", function() {
        a = a || setTimeout(function() {
            var e = window.pageYOffset > n;
...
function t396_ab__updateTildaLabelPadding(t) {
    var e, i = "bottom" === t396_ab__getFieldValue(t, "fixed-pos"),
        n = document.getElementById("tildacopy");
    n && (n = getComputedStyle(n).backgroundColor, t = t.offsetHeight, (e = document.querySelector(".tildacopy-padding")) ? i ? e.style.height = t + "px" : document.body.removeChild(e) : i && ((e = document.createElement("div")).classList.add("tildacopy-padding"), e.style.height = t + "px", e.style.backgroundColor = n, document.body.appendChild(e)))
}
